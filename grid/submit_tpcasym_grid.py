...
def run_grid(inputfiles):
    ...
    OutputDir = SBNDCALIB_GRID_OUT_DIR + "/tpc_asym/" + args.output + "__" + timestamp
    ...
    os.system('cp ./grid/bin/grid_executable_tpcasym.sh %s' %MasterJobDir)
    ...
    cp_lifetime_loop = "cp " + CALIB_WORKING_DIR + "/src/run_tpc_asym_study.C " + MasterJobDir
