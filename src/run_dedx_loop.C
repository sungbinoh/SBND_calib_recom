...
void Fill_corrected_dqdx_plots(TString suffix, const TTreeReaderArray<float>& rr, const TTreeReaderArray<float>& dqdx, const TTreeReaderArray<float>& sp_x, const TTreeReaderArray<float>& pitch, double this_c_cal){
...
*/
void run_dedx_loop(int run_num = 0, double this_c_cal0 = 0.02, double this_c_cal1 = 0.02, double this_c_cal2 = 0.02) {
  ...
  while (myReader.Next()) {
    ...
    if (*selected == 0) {
      ...
      */
      ...
      Fill_track_plots("plane0_trklen_60cm_passing_cathode_coszx", dist_start, dist_end, rr0, dqdx0);
      ...
      Fill_corrected_dqdx_plots("plane0_trklen_60cm_passing_cathode_coszx", rr0, dqdx0, sp_x0, pitch0, c_cal0);
      Fill_corrected_dqdx_plots("plane1_trklen_60cm_passing_cathode_coszx", rr1, dqdx1, sp_x1, pitch1, c_cal1);
      Fill_corrected_dqdx_plots("plane2_trklen_60cm_passing_cathode_coszx", rr2, dqdx2, sp_x2, pitch2, c_cal2);

    }
  }

  TString output_rootfile_dir = getenv("OUTPUTROOT_PATH");
  TString output_file_name = output_rootfile_dir + "/output_dedx_" + run_str + ".root";
